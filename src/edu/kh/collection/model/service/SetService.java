...
public class SetService {
	...
	public void ex1() {
		...
		// (컬렉션에 저장된 데이털르 임의로 하나씩 반복적으로 꺼내는 역할)
	...
	public void ex3() {
		...
		// int -> Integer
		// char -> Character
		// Double, Boolean, Short, Float, Byte, Long
		
		int iNum = 10;
		double dNum = 3.14;
		
		// 기본 자료형 -> 포장
		Integer w1 = new Integer(iNum); // int Integer로 포장
		...
		// 기울어진 글씨? == static
		// static은 클래스명.필드명 / 클래스명.메소드명() 호출 기능
		
		System.out.println("static 방식으로 Wapper 클래스 사용하기");
	...
	public void ex4() {
		...
		// Wapper 클래스의 AutoBoxing / AutoUnboxing
	...
	// (Integer)   (int -> Integer) 자동 포장
		...
		// Integer는 int의 포장형태라는걸 Java인식하고 있음
		// + 연산 시 포장을 자동으로 벗겨냄
	...
	public void lotto() {
		...
		// Integer는 eqauls(), hashCode() 이미 오버라이딩 완료 상태
